...
exports.openapiSpec = {
    ...
    info: {
        ...
        version: '1.0.0',
        description: 'API for locking/unlocking PDFs, sending documents, sending emails, and QuickBooks integrations.'
    },
    servers: [
    ...
    paths: {
        ...
        '/api/docs/send': {
            post: {
                ...
                description: 'Accepts multipart/form-data with a PDF file under field name "document" and a text field "customerId".',
                tags: ['documents'],
                requestBody: {
                    required: true,
                    content: {
